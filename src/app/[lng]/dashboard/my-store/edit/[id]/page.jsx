...
export default async function Page({ params }) {
  ...
  function SectionCard({ section, customBtnColor = 'btn-active' }) {
    return (
  ...
  return (
    <div className='container'>
      ...
      <div className='row d-flex align-items-stretch align-items-center justify-content-center g-3 mt-3'>
        <SectionCard section='general' />
        <SectionCard section='items' />
        <SectionCard section='tables' />
        <SectionCard section='working-hour' />
        <SectionCard section='delete' customBtnColor='btn-danger text-light' />
      </div>
    </div>
  );
}
